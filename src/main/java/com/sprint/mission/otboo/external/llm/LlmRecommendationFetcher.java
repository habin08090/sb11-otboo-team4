...
public class LlmRecommendationFetcher {
  ...
  private static final String SYSTEM_PROMPT = """
      ...
      후보 목록에 등장하는 모든 type(종류)에서 최소 1벌씩은 반드시 골라주세요.
      신발, 가방처럼 눈에 덜 띄는 종류도 빠뜨리면 안 됩니다.
      같은 type에서 여러 벌을 골라도 됩니다. type마다 최대 3벌까지 골라주세요.
      날씨에 어울리지 않는 의상은 그 type의 다른 의상으로 대신 골라주세요.
